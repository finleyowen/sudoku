...
**This project is currently working, however most the algorithms are very slow and none have been successfully executed on all of the tests yet for this reason. The stack-based DFS seems to be the fastest of the algorithms currently implemented.**
